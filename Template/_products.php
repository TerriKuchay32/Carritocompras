        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button type="submit" class="btn btn-danger form-control">Proceda a comprar</button>
                    </div>
                    <div class="col">
                        <?php
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        ...
                        <td class="font-size-20 text-danger">$<span><?php echo $item['item_price'] ?? 0; ?></span><small class="text-dark font-size-12">&nbsp;&nbsp;Inpuestos</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Ahorras:</td>
                        <td><span class="font-size-16 text-danger">$890.00</span></td>
                    </tr>
                </table>
